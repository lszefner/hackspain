...
.PHONY: help centralita web-centralita export voces erp erp-fast erp-lote2 erp-lote2-fast erp-status erp-login rules rules-offline rules-all-policies scan scan-gen test eval-fixtures eval-score eval-score-live e2e-fixtures e2e-score e2e-score-live
