...
| provisional | 30 | 30 | 0.8333 | 0.7163 | 0.0000 |
...
```json
{
  ...
  "total_cost_usd": null,
  "known_latency_seconds": 116.23929054300606,
  "latency_known_documents": 30,
  "usage_totals": {
    "input_tokens": 1756181.0,
    "output_tokens": 657050.0
  },
  "attempts": 142
}
```
...
| 2026-01-15_P003.pdf | development | draft_or_unavailable | failed | 0.0000 | 0 |
...
| FA-4290_mensajería.pdf | development | draft_or_unavailable | failed | 0.0000 | 0 |
...
| FA-4673_informática.pdf | development | draft_or_unavailable | failed | 0.0000 | 0 |
| FA-4813_seguridad.pdf | development | draft_or_unavailable | failed | 0.0000 | 0 |
...
| scan_018.pdf | development | draft_or_unavailable | failed | 0.0000 | 1 |
